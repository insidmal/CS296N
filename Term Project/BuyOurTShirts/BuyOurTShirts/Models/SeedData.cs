    ...
    public class SeedData
    {
        ...
        public static void Initialize(IServiceProvider services)
        {
            ...
            if (!context.Account.Any())
            {
                ...
                AddRoles(new List<Account> { admin, bM }, services, context);
        ...
        public static async void AddRoles(List<Account> accounts, IServiceProvider services, BotsDbContext context)
        {
            UserManager<Account> userManager = services.GetRequiredService<UserManager<Account>>();

            await userManager.AddToRoleAsync(accounts.Last(), "Band Member");
            await userManager.AddToRolesAsync(accounts.First(), new string[] { "Band Member", "Administrator" });
